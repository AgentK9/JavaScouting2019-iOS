...
class TOAGrab {
	...
	{
		do {
			var toTeam: ScoutingTeam! = ScoutingTeam(teamNum: -1, teamName: nil, record: nil, bestScore: nil, latestScore: nil, path: "", scouting: [ScoutingData](), compRecord: [0, 0, 0], QP: nil, TBP: nil)
